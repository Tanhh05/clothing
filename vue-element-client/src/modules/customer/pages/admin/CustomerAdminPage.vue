  ...
  <section class="customer-admin-page admin-page-shell" v-loading="loading">
    <div class="panel">
      <div class="panel-head">
        ...
        <el-select v-model="statusFilter" style="width: 160px" @change="applySearch">
          <el-option label="Tất cả trạng thái" value="" />
          <el-option label="ACTIVE" value="ACTIVE" />
          <el-option label="INACTIVE" value="INACTIVE" />
        </el-select>
        <el-button type="primary" @click="applySearch">Tìm</el-button>
        <el-button @click="refreshFilters">Làm mới</el-button>
      </div>
